...
def main():
    ...
    csv_path_beta_large = Path("results/anpm_synthetic_beta_largegapsto.csv")
    n_beta = 8
    ...
    csv_path_beta_small = Path("results/anpm_synthetic_beta_smallgapsto.csv")
    ...
    # (Bottom left) Gap
    csv_path_gap = Path("results/anpm_synthetic_gap_sto.csv")
    n_gap = 6
    ...
    # (Bottom right) Noise
    csv_path_noise = Path("results/anpm_synthetic_noise_sto.csv")
    n_noise = 6
